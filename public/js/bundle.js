...
},{"axios":"../../node_modules/axios/index.js"}],"createForm.js":[function(require,module,exports) {
"use strict";
...
var createPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, startDates, imageCover, images, summary, description, duration, startAddress, startCoordinates, startDescription) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(name, startDates, imageCover, images, summary, description, startAddress, startCoordinates, startDescription);
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
  ...
  return function createPost(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref.apply(this, arguments);
  };
}();
...
if (_base.elements.createForm) {
  _base.elements.createForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('blogName').value;
    var startDates = document.getElementById('blogStartDates').value;
    var imageCover = document.getElementById('blogImageCover').value;
    var images = document.getElementById('blogImage').value;
    var summary = document.getElementById('blogSummary').value;
    var description = document.getElementById('blogDescription').value;
    var duration = document.getElementById('blogDuration').value;
    var latitude = document.getElementById('blogLatitude').value;
    var longitude = document.getElementById('blogLongitude').value;
    var startAddress = document.getElementById('blogAddress').value;
    var startDescription = document.getElementById('blogStartDescription').value;
    console.log(longitude, latitude);
    var startCoordinates = [latitude, longitude]; // console.log(name, startDates, ImageCover, Image, Summary, Description);

    (0, _createForm.createPost)(name, startDates, imageCover, images, summary, description, duration, startAddress, startCoordinates, startDescription);
  });
}
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./base":"base.js","./comment":"comment.js","./createForm":"createForm.js","moment":"../../node_modules/moment/moment.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
